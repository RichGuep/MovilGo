...
# =========================================================
# 4. GESTIÓN DE PERSONAL (ASIGNACIÓN INDIVIDUAL)
# =========================================================
def asignar_grupos_automatico(df):
    ...
    # Abordaje: Se marca como bloque único para gestión individual en malla
...
def pantalla_personal():
    ...
    if 'df_pers' in st.session_state:
        if st.button("🎲 Asignar Grupos Técnicos y Activar Planta Abordaje"):
...
def generar_malla_abordaje_individual(inicio, fin):
    """Motor Abordaje Individual: 10 T1, 10 T2, 7 Disponibles, Mitad Sábado y Mitad Domingo."""
...
def pantalla_programador():
    ...
    if m_key in st.session_state:
        ...
        st.subheader("📊 Análisis de Planta")
        a1, a2 = st.columns(2)
