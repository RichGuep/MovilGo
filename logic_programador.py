...
# VERSIÓN COMPLETA ESTABLE + ABORDAJE + MALLA + AUDITORÍA + DESCANSO FLEXIBLE
...
def generar_malla_tecnicos():
    ...
    if st.button("🚀 Generar malla"):
        ...
        # =====================================================
        # 📊 MALLA VISUAL (LO QUE TE FALTABA)
        # =====================================================
        ...
        c1.metric("Turnos", len(df[df["Turno"].isin(["T1","T2","T3"])]))
